package net.dev.mylib.sharedPreferences;
...
public class SharedPreferencesUtil {
    ...
    public void saveLoginAuto(String userAutoLogin){
    	mEditor.putString(PREFERENCES_AUTO_LOGIN, userAutoLogin);
    	mEditor.commit();
    }
    ...
    public void saveLoginInfo(Boolean autoLogin, String userName,String userPassword,String userId) {  
        assert (mEditor != null);  
